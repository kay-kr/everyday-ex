...
window.DB_PAGES = [
  ...
  { title: "3주 루틴",  href: "_dashboard/plan.html",          summary: "9월 14일부터 10월 2일까지 15개 세션의 전체 루틴. 요일별 성격, 워밍업·메인·쿨다운 구성과 세트 수, 블록마다 어떻게 쉬는지, 그날 챙길 준비물까지. 수요일은 축구 레슨이다." },
  { title: "동작 사전", href: "_dashboard/moves.html",          summary: "레그스윙부터 론도·숏게임까지, 이 플랜과 수요일 레슨에 나오는 모든 동작의 하는 순서와 자세 요령. 이름만 보고 모르겠을 때 찾는 곳이다." },
  { title: "무릎 관리", href: "_dashboard/knee.html",          summary: "왼쪽 무릎 안전 규칙, 통증 신호등, 매일 하는 재활 5종, 수요일 레슨 날의 상한과 중단 기준. 통증이 생기면 여기부터 본다." },
